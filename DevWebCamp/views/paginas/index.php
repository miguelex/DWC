    ...
    <div class="speakers__grid">
        ...
        <div data-aos="<?php aos_animacion(); ?>" class="speaker">
            <picture>
                ...
                <img loading="lazy" class="speaker__imagen" width="200" height="300"
                    src="<?php echo 'img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen Ponente">
            </picture>
            ...
            <ul class="speaker__listado-skills">
                ...
                <li class="speaker__skill"><?php echo trim($tag); ?></li>
                <?php } ?>
            </ul>
        </div>
        <?php } ?>
